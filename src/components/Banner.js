...
function Banner(props) {
  return (
    <div  className= "banner" style = {{alignItems: "center", backgroundColor: [props.bgColor], backgroundImage: [props.bgImage]}}>
      ...
      <Description textSize = {props.txtSize} txtWeight = {props.txtWeight} bgImage = {props.bgImage} txtPre = {props.txtPre} highlightColor = {props.highlightColor} highlightTxt = {props.highlightTxt} />
